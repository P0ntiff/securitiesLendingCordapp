package com.secLendModel.gui.views.cordapps.cash
...
class NewTransaction : Fragment() {
    ...
    private val supportedCurrencies by observableList(IssuerModel::currencyTypes) //todo why wasnt supportedCurrencies available
